...
export default function InvestmentStages(props: Props) {
  ...
  return (
    <div class="mx-auto xl:max-w-[1200px] xl:px-0 px-[15px] w-full lg:mt-[120px] md:mt-[75px] mt-[50px]">
      <div class="w-full grid md:gap-[24px] gap-[75px] grid-cols-1 md:grid-cols-five">
