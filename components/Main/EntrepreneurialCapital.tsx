...
export default function EntrepreneurialCapital(props: Props) {
  return (
    <section class="h-screen relative">
      <Image class="w-full h-full object-cover z-0 absolute" src={props.background} alt={"background"} width={1920} height={1080}/>
      ...
      <div class="w-full h-screen flex-center-between flex-col relative">
        <h1 class="text-white text-center text-[40px] z-5 inherit leading-none py-[80px] my-auto  xl:(text-[120px] l-container) md:(text-[90px])"
          style="white-space: pre-line; font-family: 'Noe Display Bold', sans-serif;">
          {props.title}
        </h1>
        <div class="w-full flex-center-between xl:px-[0px] px-[12px] bottom-[40px] absolute w-full mx-auto xl:(l-container)"
