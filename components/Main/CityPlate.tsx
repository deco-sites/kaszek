  ...
  return (
    ...
    >
      ...
      >
        ...
        <span class="block bg-[#005046] top-[40px]  text-[#83ff97] text-[14px] font-bold px-[15px] py-2 uppercase leading-none absolute sm:left-1/2 transform sm:-translate-x-1/2 -translate-x-[25%] mt-1 whitespace-nowrap">
          {name}
        </span>
      </div>
    </div>
