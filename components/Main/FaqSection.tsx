  ...
  return (
    <section class="w-full pt-[50px] md:pt-[75px] lg:pt-[120px] pb-[75px] max-w-[1200px] xl:px-0 px-[15px]">
        <div style={{ WebkitTapHighlightColor: 'transparent' }}>
            <h3 class="md:text-[76px] text-[36px] font-bold color-green leading-[1] tracking-[-.5px] sm:h-[79.19px] md:h-[152px] inline-flex items-end">FAQ</h3>
            ...
            {faqs.map((faq, index) => (
                    <>
                        <div class={`flex justify-between items-center cursor-pointer py-[36px] ${faq.isOpen ? '' : ' border-b-1 border-solid border-[#83ff97]'}`}
                            ...
                            <h4 class="text-[24px] font-bold color-green pr-[72px]">{faq.question}</h4>
