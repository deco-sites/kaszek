  ...
  return (
    <section class="w-full mx-auto pt-[50px] md:pt-[75px] lg:pt-[120px] pb-[75px] max-w-[1200px] xl:px-0 px-[15px]">
        <div style={{ WebkitTapHighlightColor: 'transparent' }}>
            <h3 class="md:text-[76px] text-[36px] color-green leading-[1] tracking-[-.5px] w-full h-[79.19px] md:h-[152px] inline-flex items-end uppercase Noe-Display-Font">{props.title_section}</h3>
