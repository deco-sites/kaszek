  ...
  return (
    <section class="w-full mx-auto pt-[50px] md:pt-[75px] lg:pt-[120px] pb-[75px] max-w-[1200px] xl:px-0 px-[15px]">
        <div style={{ WebkitTapHighlightColor: 'transparent' }}>
            <h3 class="md:text-[76px] text-[36px] font-bold color-green leading-[1] tracking-[-.5px] w-full h-[79.19px] md:h-[152px] inline-flex items-end uppercase Noe-Display-Font">{props.title_section}</h3>
            ...
            {faqs.map((faq, index) => (
                    <>
                        <div class={`flex justify-between items-center cursor-pointer py-[36px] ${faq.isOpen ? '' : ' border-b-1 border-solid border-[#83ff97]'}`}
                            ...
                            <object data={asset(`/imgs/arrow-accordion.svg`)} aria-label="accordion menu toggle" width="34" height="34" class={`transform pointer-events-none ${
