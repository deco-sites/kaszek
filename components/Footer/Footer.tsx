      ...
      <div class="l-container mx-auto xl:px-0 px-[12px]">
        <div class="grid lg:grid-cols-3 lg:gap-[24px] md:gap-y-0 gap-x-[24px] gap-y-[60px] lg:mb-[150px] mb-[120px] md:grid-cols-2 grid-cols-1">
          <div>
            ...
            <a
              href="mailto:info@kaszek.com"
              class="color-green font-bold uppercase text-[14px] tracking-[1px]"
            ...
            <ul class="lg:flex-center-end flex items-center justify-start">
              <li>
                <a
                  target="_blank"
                  rel="noopener"
                  href="https://www.linkedin.com/company/2892335"
                  class="arrow-icon color-green font-bold uppercase text-[14px] tracking-[1px] mr-[30px]"
                  style="font-family: 'Maax Bold', sans-serif;"
                >
                  Linkedin
                </a>
              ...
              <li>
                <a
                  target="_blank"
                  rel="noopener"
                  href="https://www.instagram.com/kaszekventures"
                  class="arrow-icon color-green font-bold uppercase text-[14px] tracking-[1px]"
                  style="font-family: 'Maax Bold', sans-serif;"
                >
                  Instagram
                </a>
        ...
        <div className="text-[16px]">
          © {currentYear} Kaszek. All Rights Reserved
        </div>
      </div>
      <style
